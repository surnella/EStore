...
INSERT INTO `order_header` VALUES (10001,1,'Credit Card',50001,'1000'),(10002,2,'Cash',50001,'1000'),(10003,5,'Cash',50001,'1000'),(10004,5,'Credit Card',50001,'1000'),(10005,5,'Credit Card',50002,'1000'),(10006,6,'Net Banking',50003,'1000'),(10007,3,'Cash',50004,'1000'),(10008,7,'Credit Card',50002,'1000'),(10009,4,'Credit Card',50003,'1000'),(10010,6,'Cash',50004,'1000'),(10011,1,'Credit Card',50001,'1000'),(10012,2,'Credit Card',50004,'1000'),(10013,8,'',0,'1000'),(10014,9,'Credit Card',50005,'1000'),(10015,10,'Credit Card',50003,'1000'),(10016,8,'Cash',50004,'1000'),(10017,6,'Cash',50004,'1000'),(10018,11,'Credit Card',50001,'1000'),(10019,12,'Credit Card',50002,'1000'),(10020,18,'Net Banking',50003,'1000'),(10021,25,'Credit Card',50006,'1000'),(10022,23,'Credit Card',50006,'1000'),(10023,36,'Credit Card',50002,'1000'),(10024,32,'Net Banking',50005,'1000'),(10025,28,'Credit Card',50001,'1000'),(10026,21,'Net Banking',0,'1000'),(10027,23,'Credit Card',50001,'1000'),(10028,23,'Credit Card',0,'1000'),(10029,25,'Credit Card',50003,'1000'),(10030,52,'Credit Card',50006,'1000'),(10031,33,'',0,'1000'),(10032,7,'Credit Card',50003,'1000'),(10033,28,'Credit Card',50002,'1000'),(10034,19,'Credit Card',50001,'1000'),(10035,24,'Net Banking',50004,'1000'),(10036,24,'Cash',50001,'1000'),(10037,2,'Cash',50005,'1000'),(10038,46,'Net Banking',50005,'1000'),(10039,14,'Net Banking',50005,'1000'),(10040,3,'Credit Card',50005,'1000'),(10041,51,'',0,'1000'),(10042,26,'Credit Card',50004,'1000'),(10043,17,'Net Banking',50002,'1000'),(10044,39,'Net Banking',0,'1000'),(10045,34,'Credit Card',0,'1000'),(10046,3,'Net Banking',50002,'1000'),(10047,24,'Net Banking',50005,'1000'),(10048,33,'Cash',50002,'1000'),(10049,33,'Credit Card',0,'1000'),(10050,1,'Net Banking',0,'1000'),(10051,43,'Credit Card',50006,'1000'),(10052,17,'',0,'1000'),(10053,40,'Credit Card',50005,'1000'),(10054,19,'Credit Card',50004,'1000'),(10055,25,'Credit Card',50006,'1000'),(10056,11,'Credit Card',50004,'1000'),(10057,11,'Cash',50005,'1000'),(10058,28,'',0,'1000'),(10059,30,'Net Banking',50001,'1000'),(10060,50,'Credit Card',50005,'1000'),(10061,37,'Credit Card',50001,'1000'),(10062,34,'',0,'1000'),(10063,18,'Credit Card',50001,'1000'),(10064,35,'Credit Card',50004,'1000'),(10065,17,'Net Banking',0,'1000'),(10066,41,'',0,'1000'),(10067,6,'Credit Card',0,'1000'),(10068,51,'Credit Card',50004,'1000'),(10069,23,'Net Banking',50002,'1000'),(10070,10,'Net Banking',50001,'1000');
...
CREATE TABLE `discounts` (
  ...
  `DISCOUNT_PERCENT` int DEFAULT -1,
  `DISCOUNT_STATUS` int DEFAULT 0,
  PRIMARY KEY (`DISCOUNT_ID`),
  KEY `FKY_CUSTID` (`CUSTOMER_ID`),
  CONSTRAINT `FKY_CUSTID` FOREIGN KEY (`CUSTOMER_ID`) REFERENCES `online_customer` (`CUSTOMER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `cart_items` VALUES (27,3,1),(27,2,2);
...
INSERT INTO `product` VALUES (NULL,'Sky LED 102 CM TV',2050,35000.00,300,905,750,700,15.0000),(NULL,'Sams 192 L4 Single-door Refrigerator',2050,28000.00,150,1802,750,750,25.0000),(NULL,'Jocky Speaker Music System HT32',2050,8900.00,19,908,300,300,5.0000),(NULL,'Cricket Set for Boys',2051,4500.00,10,890,300,200,18.0000),(NULL,'Infant Sleepwear Blue',2052,250.00,50,596,300,100,0.2500),(NULL,'Barbie Fab Gown Doll',2051,1000.00,20,305,150,75,0.1500),(NULL,'Remote Control Car',2051,2900.00,12,200,150,50,0.2250),(NULL,'Doll House',2051,3000.00,12,600,455,375,0.9000),(NULL,'Blue Jeans 34',2052,800.00,100,450,310,52,1.1000),(NULL,'Blossoms Lehenga Choli set',2052,3000.00,100,600,315,54,0.2500),(NULL,'OnePlus 6 Smart Phone',2055,32500.00,25,100,65,15,0.5500),(NULL,'Samsung Galaxy On6',2055,14000.00,20,120,70,18,0.6500),(NULL,'Alchemist',2054,150.00,50,200,100,20,0.2350),(NULL,'Harry Potter',2054,250.00,50,210,100,50,0.3450),(NULL,'Logtech M244 Optical Mouse',2053,450.00,10,125,85,45,0.1050),(NULL,'External Hard Disk 500 GB',2053,3500.00,7,275,285,85,0.5250),(NULL,'Titan Karishma Watch',2057,3497.00,35,220,55,24,0.1030),(NULL,'Shell Fingertip Ball Pen',2056,25.00,150,170,12,170,0.0500),(NULL,'Ruf-n-Tuf Black PU Leather Belt',2052,350.00,50,700,45,4,0.1550),(NULL,'Hello Kitti Lunch Bag',2059,199.00,15,455,300,225,0.5000),(NULL,'Cybershot DWC-W325 Camera',2050,5300.00,5,100,55,40,0.0500),(NULL,'KitchAsst Siphon Coffee Maker 500 ml',2060,1790.00,10,150,100,200,1.2000),(NULL,'Sams 21L Microwave Oven',2060,6880.00,5,500,400,300,8.0000),(NULL,'Phils HL 7430 Mixer Grinder 750W',2060,2265.00,3,375,400,355,3.0000),(NULL,'Solmo Non-stick Sandwich Maker 750 W',2060,1625.00,10,150,175,70,0.7500),(NULL,'Solmo Hand Blender Fibre',2060,1415.00,7,220,100,220,0.5600),(NULL,'Phils Wah Collection Juicer JM12',2060,2029.00,2,400,450,425,4.0000),(NULL,'Adidas Analog Watch',2057,2295.00,7,225,60,28,0.1150),(NULL,'Disney Analog Watch',2057,1600.00,10,225,60,28,0.1150),(NULL,'Esprit Analog Watch',2057,3495.00,2,225,60,28,0.1150),(NULL,'HP ODC Laptop Bag 15.5',2059,3390.00,7,550,400,210,0.2550),(NULL,'Women Hand Bag',2059,1600.00,15,250,220,170,0.1750),(NULL,'HP ODC School Bag 2.5\'',2059,799.00,14,600,450,275,0.3550),(NULL,'FLUFF Tote Travel Bag 35LTR',2059,3290.00,4,900,800,600,4.0000),(NULL,'Cindy HMPOC Pencil Box (Multicolor)',2056,80.00,10,250,50,15,0.4500),(NULL,'Solo Exam SB-01 Writing Pad',2056,350.00,21,400,300,5,0.5500),(NULL,'Zamark Color Pencil Art Set',2056,100.00,10,120,90,20,0.3500),(NULL,'Kasyo DJ-2100 Desktop Calculator',2056,338.00,10,150,120,120,0.5500),(NULL,'TRANS 2D A4 Size Box File',2056,120.00,6,350,300,100,0.3150),(NULL,'4M Post It Pad 3.5',2056,35.00,8,80,80,150,0.1200),(NULL,'PK Copier A4 75 GSM White Paper Ream',2056,285.00,2,297,210,0,0.0000),(NULL,'GreenWud CT-NO-PR Coffee Table',2058,3500.00,6,1250,550,700,50.0000),(NULL,'Supreme Fusion Cupboard 02TB',2058,3000.00,3,1200,350,900,60.0000),(NULL,'Foldable Premium Chair',2058,4000.00,6,75,70,90,20.0000),(NULL,'GreenWud Nova Pedestal Unit',2058,2500.00,5,400,400,600,25.0000),(NULL,'Exam Warriors',2054,100.00,50,200,160,15,0.1000),(NULL,'Small Is Beautiful',2054,140.00,40,180,100,15,0.1000),(NULL,'To Kill a Mocking Bird',2054,210.00,35,190,150,20,0.1500),(NULL,'All-in-one Board Game',2051,450.00,20,750,320,90,0.5000),(NULL,'Huwi Wi-Fi Receiver 500Mbps',2053,287.00,30,100,95,30,0.1000),(NULL,'Quanta 4 Port USB Hub',3000,500.00,50,180,125,30,0.0500),(NULL,'Dell Targus Synergy 2.0 Backpack',3002,999.00,250,450,250,50,0.5000),(NULL,'Tom Clancy\'s Ghost Recon: Future Soldier (PC Game)',3002,999.00,250,150,200,10,0.1000),(NULL,'Nokia 1280 (Black)',3002,999.00,250,45,107,15,0.0820),(NULL,'HP Deskjet 2050 All-in-One - J510a Printer',3001,3749.00,100,249,427,406,3.6000),(NULL,'LG MS-2049UW Solo Microwave',3001,4800.00,100,455,252,320,5.6000),(NULL,'Nokia Asha 200 (Graphite)',3001,4070.00,100,61,115,14,0.1050),(NULL,'Sony Xperia U (Black White)',3000,16499.00,50,54,112,12,0.1100),(NULL,'Nikon Coolpix L810 Bridge',3000,14987.00,50,111,76,83,0.4300),(NULL,'Samsung Galaxy Tab 2 P3100',3000,19300.00,50,122,194,10,0.3450);
